...
//             <h3 className="text-2xl font-bold gradient-text mb-2 text-white">Wasi Haider</h3>
//             <p className="text-gray-400">
//               Made with <Heart className="w-4 h-4 inline text-red-500 mx-1" /> using React & Tailwind CSS
//             </p>
...
//           <button
//             onClick={scrollToTop}
//             className="w-12 h-12 bg-gradient-to-r from-purple-600 to-pink-600 rounded-full flex items-center justify-center text-white hover:scale-110 transition-all duration-300 glow-effect"
